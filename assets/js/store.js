...
export const DEFAULT_PROJECTS = [
  ...
  {
    kind: 'consign',
    title: '미래 기후변화를 고려한 장대레일 안전성 강화 방안 연구용역',
    owner: '김만철 수석',
    org: '궤도노반연구실',
    ..._RANGE, budget: _BUDGET, goal: '',
    techDefinition: '', techFeatures: [], activities: [],
  ...
  {
    kind: 'consign',
    title: '철도교 캠버량을 고려한 교량 및 궤도분야 관련 설계기준 정립 연구',
    owner: '황성호 책임',
    org: '궤도노반연구실',
    ..._RANGE, budget: _BUDGET, goal: '',
    techDefinition: '', techFeatures: [], activities: [],
  ...
  {
    kind: 'consign',
    title: '운행선 인접 지하구간 철도건설사업을 위한 자갈궤도 진동허용기준 수립용역',
    owner: '최찬용 책임',
    org: '궤도노반연구실',
    ..._RANGE, budget: _BUDGET, goal: '',
    techDefinition: '', techFeatures: [], activities: [],
  ...
  {
    kind: 'etc',
    title: 'AI를 활용한 업무(연구, 행정 등) 자동화 사례',
    owner: '',
    org: '궤도노반연구실',
    ..._RANGE, budget: _BUDGET, goal: '',
    techDefinition: '', techFeatures: [], activities: [],
